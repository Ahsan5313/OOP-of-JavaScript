...
class Car {
         ...
         // privet fill
         #warranty;
    constructor(name,year, warranty){
    ...
    aboutCar(){
        ...
        console.log(`My car name is ${this.name} and it has been created in ${this.year}`)
        this.#carWarranty()
    }

    #carWarranty(){

        console.log(`${this.name} is gonna be warranty for ${this.#warranty} years`)
    }
}

const bmw = new Car('BMW', 2000, 3);
